    ...
    >
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-zinc-400 max-w-xl mx-auto text-sm sm:text-base leading-relaxed">
          AnlıkResim platformunu kullanırken uymanız gereken kurallar, yasal sorumluluklar ve sunduğumuz hizmet kalitesi standartları.
        </p>
      </div>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="rounded-2xl border border-zinc-900 bg-zinc-950/20 p-6 space-y-4">
            ...
            <p className="text-sm text-zinc-300 leading-relaxed">
              AnlıkResim, yasalara uygun her türlü görsel içeriğin paylaşımı için ücretsiz hizmet vermektedir. Ancak aşağıdaki niteliklere sahip içeriklerin platformumuza yüklenmesi kesinlikle yasaktır:
            </p>
          ...
          <div className="rounded-2xl border border-zinc-900 bg-zinc-950/20 p-6 space-y-4">
            ...
            <p className="text-sm text-zinc-300 leading-relaxed">
              Yüklediğiniz tüm görsellerin mülkiyeti ve yasal sorumluluğu tamamen size (yükleyen kişiye) aittir. AnlıkResim, yüklediğiniz görseller üzerinde hiçbir mülkiyet iddiasında bulunmaz. Ancak, görsellerin sitenizde veya paylaştığınız yerlerde görüntülenebilmesi için platformumuza barındırma ve dağıtım lisansı vermiş sayılırsınız.
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-zinc-900 bg-zinc-950/20 p-5 space-y-3 text-xs text-zinc-400">
            ...
            <p className="leading-relaxed">
              AnlıkResim, 5651 sayılı kanun kapsamında "Yer Sağlayıcı" olarak hizmet vermektedir. Yüklenen yasa dışı içeriklerden platformumuz sorumlu tutulamaz; sorumluluk tamamen yükleyen tarafa aittir.
            </p>
          </div>
        </div>
