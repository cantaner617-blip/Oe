...
const FILTER_OPTIONS: FilterOption[] = [
  ...
  { id: 'modern', name: 'Modern', class: 'contrast-115 saturate-120 brightness-102', filterString: 'contrast(115%) saturate(120%) brightness(102%)', isPremium: true },
  { id: 'vintage_premium', name: 'Vintage', class: 'sepia-35 contrast-110 saturate-90 hue-rotate-5', filterString: 'sepia(35%) contrast(110%) saturate(90%) hue-rotate(-5deg)', isPremium: true },
  { id: 'noir', name: 'Noir', class: 'grayscale-100 contrast-150 brightness-90', filterString: 'grayscale(100%) contrast(150%) brightness(90%)', isPremium: true },
